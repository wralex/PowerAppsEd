...
3. Open each application and sign in using your organization's tenant login (*i.e., jsmith@domain.com*).

4. Download a local copy of the Power BI PBIX file from the following URL
    [AdventureWorksDW2020.pbix](Resources/AdventureWorksDW2020.pbix)
...
6. Publish the report `AdventureWorksDW2020` to your personal workspace called **My workspace** using the button icon on top right of the **Power BI Desktop** application
    ...
    ![Publish To My workspace](Resources/PowerBI_Publish.png)

    ![Open 'AdventureWorksDW2020.pbix' in Power BI](Resources/PowerBI_PublishToMyWorkspace.png)
...
7. Click on the link after you publish the report to confirm that the report has been placed out to your online **My workspace**
    ...
    ![Open 'AdventureWorksDW2020.pbix' in Power BI](Resources/PowerBI_ClickLinkToMyWorkspace.png)
...
1. Open the **Power BI Report Builder** application.
    ...
    ![Power BI Report Builder](Resources/Power%20BI%20Report%20Builder%20-%20Icon.png)
...
18. In the **Image Properties** window, click **OK**.

19. In the report designer, notice that the image was added, and is selected.

20. To position and resize the image, in the **Properties** pane, configure the following properties:
...
21. To resize the report header region, first select the region by clicking a blank area of the region.

22. In the **Properties** pane, set the **General | Height** property to **1**.

23. Verify that the report header region contains a single textbox and image, and looks like the following:
...
24. To save the report, on the **File** tab, click **Save**.
...
2. Verify that you are currently signed into your organization's environment by viewing the top right area of the application and see your display name below the Minimize, Maximize, & Close icons. If you are not signed in, then click the **Sign In** message and go through the authenication process to connect to the online environment.
    ...
    ![Signed In](Resources/Power%20BI%20Report%20Builder%20-%20Logged%20In.png)
...
4. On the "Select a dataset from the Power BI Service" make sure you have selected **My Workspace** on the left panel and **AdventureWorksDW2020** Dataset on the right panel and keep the Dataset name as  `AdventureWorksDW2020` and click the **Select** button on the bottom.
    ...
    ![Select Dataset](Resources/PowerBI%20-%20Selecting%20AdventureWorksDW2020%20Dataset.png)

5. Right-Click the new Data Source (*most likely named **MyWorkspace_AdventureWorksDW2020***) and Left-Click the  **Rename** selection

     ![Rename Dataset](Resources/Power%20BI%20-%20Rename%20Dataset.png)

6. Change the **Name** box with the text with `AdventureWorksDW2020`

    ![New Name](Resources/Power%20BI%20Report%20Builder%20-%20AdventureWorksDW2020%20Dataset.png)

7. Right click on the **Parameters** folder icon and click **Add Parameter...**

    ![Add Parameter](Resources/PBI%20Add%20Parameter.png)
...
10. **Right**-click on the link below and select the **Save link as** option to place the DAX file onto your workstation to be used for the next steps. **Make note of where you place this file on your workstation**
    ...
    [SalesOrder.dax](Resources/SalesOrder.dax)
...
12. Click on the **Parameters** view on the left and click the **Add** button to add a parameter to use in the query.
    ...
    ![Add Param to Dataset](Resources/PBI%20Add%20Param%20to%20Dataset.png)
...
20. Notice the use of **@SalesOrderNumber** paramter in the `VAR __DS0FilterTable` clause, which represents a query parameter.
    ...
    ![Picture 3](Resources/PBI%20SalesOrder%20Param.png)
...
5. In the **Value** dropdown list, replace the text with **SO43665**.
    ...
    ![Picture 50](Resources/PBI%20Default%20Param%20Value.png)
...
34. Verify that the rendered report looks like the following:
    ...
    ![Picture 4](Resources/PBI%20Sample%20Run%2001.png)
...
12. Preview the report.
    ...
    ![Picture 11](Resources/PBI%20Report%20Sample%20with%20Table.png)
...
21. Verify that the rendered report looks like the following:
    ...
    ![Picture 6](Resources/PBI%20Sales%20Order%20Detail%20with%20Table%20Format.png)
